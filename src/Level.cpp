...
Level::Level()
{
	...
	// addBoardObj(brickWallH, sf::Vector2f(204,400));
	// addBoardObj(brickWallH, sf::Vector2f(252,400));
	// addBoardObj(brickWallH, sf::Vector2f(396,400));
	// addBoardObj(brickWallH, sf::Vector2f(348,400));
	addBoardObj(brickWallH, sf::Vector2f(300,400));
